...
export class AuthService {
      ...
      tap((response: any) => {
        ...
        if (response && response.token) {
          if (isPlatformBrowser(this.platformId)) {
            ...
            console.log('Username extracted after login:', username); 
            this.currentUserSubject.next(username);
            console.log('currentUserSubject updated with:', username); 
          }
        } else {
  ...
  logout(): void {
    if (isPlatformBrowser(this.platformId)) {
      ...
      console.log('Logged out. currentUserSubject set to null'); 
    }
  }
  ...
  getUsername(): string | null {
    ...
    console.log('Extracted username:', username, 'nameid (user ID):', decoded.nameid); 
    return username;
  }
